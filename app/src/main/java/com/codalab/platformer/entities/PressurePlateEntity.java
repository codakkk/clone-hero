...
public class PressurePlateEntity extends BaseEntity implements IActivable {
    public static PressurePlateEntity factory(GameWorld gameWorld, Vector2 position) {
        PressurePlateEntity go = new PressurePlateEntity(position);
    ...
    PressurePlateEntity(Vector2 position) {
        super(position);
    ...
    public void draw(MyGraphics g) {
        ...
        g.draw(screenX, screenY,  state ? 4 + 3 * 32 : 5 + 3 * 32);
    }
