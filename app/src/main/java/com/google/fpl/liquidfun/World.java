...
public class World {
  ...
  public void queryAABB(QueryCallback callback, AABB aabb) {
    liquidfunJNI.World_queryAABB__SWIG_0(swigCPtr, this, QueryCallback.getCPtr(callback), callback, AABB.getCPtr(aabb), aabb);
  }
  ...
  public PrismaticJoint createPrismaticJoint(PrismaticJointDef def) {
    long cPtr = liquidfunJNI.World_createPrismaticJoint(swigCPtr, this, PrismaticJointDef.getCPtr(def), def);
    return (cPtr == 0) ? null : new PrismaticJoint(cPtr, false);
  }

  public RevoluteJoint createRevoluteJoint(RevoluteJointDef def) {
    long cPtr = liquidfunJNI.World_createRevoluteJoint(swigCPtr, this, RevoluteJointDef.getCPtr(def), def);
    return (cPtr == 0) ? null : new RevoluteJoint(cPtr, false);
  }

  public void queryAABB(QueryCallback callback, float A1, float A2, float B1, float B2) {
    liquidfunJNI.World_queryAABB__SWIG_1(swigCPtr, this, QueryCallback.getCPtr(callback), callback, A1, A2, B1, B2);
  }
